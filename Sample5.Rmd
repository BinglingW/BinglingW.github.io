---
title: "Analyzing the Sentiment of Tweets"
...
#Only selected the time of tweet, tweet content and the course of the tweet and got rid of other irrelevant variables
...
## 3. Using Sentiment to Predict Who Tweeted

#### We first split our data into train and test data. Then, we used the train data to develop a Naive Bayes algorithm.
...
#### We applied the algorithm on the test data and created a confusion matrix. 
...
#### We repeated what we did for Dan Ariely and Colin Camerer.
